...
class _MainScreenState extends State<MainScreen> {
  ...
  static const aPositCamerion _kGooglePlex = CameraPosition(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      tripDirectionDetailsInfo != null ? "৳ ${((AssistantMethods.calculateFareAmountFromOriginToDestination(tripDirectionDetailsInfo!) * 2) * 107).toStringAsFixed(1)}"
                                        : "null",
                                      style: TextStyle(
                                        color: Colors.grey,
                                      ),
